  ...
  return (
    <div className="flex flex-col mt-10 w-full text-xl text-neutral-900 max-md:max-w-full">
      ...
      <div className="flex flex-col pb-16 mt-6 w-full font-medium leading-none max-md:max-w-full">
        <div className="flex overflow-hidden flex-wrap w-full rounded-3xl bg-indigo-50 min-h-[70px] max-md:max-w-full">
          <div className="flex flex-1 shrink justify-center items-center text-white bg-slate-500 min-w-[240px] shadow-[-6px_6px_0px_rgba(255,255,255,1)]">
