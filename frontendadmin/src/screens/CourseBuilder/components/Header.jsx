...
export function Header() {
  return (
    <header className="flex flex-wrap gap-6 items-center px-10 w-full text-6xl uppercase whitespace-nowrap bg-[#EBF1F9] text-blue-950 max-md:px-5 max-md:max-w-full max-md:text-4xl">
