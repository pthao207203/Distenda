...
export default function CoursesLesson() {
  return (
    <div className="flex overflow-hidden flex-col grow shrink self-stretch my-auto min-w-[240px] w-[368px] max-md:max-w-full">
      ...
      <div className="flex flex-col pt-2 w-full leading-none bg-white max-md:max-w-full">
        <div className="flex flex-col px-3 w-full text-xl text-black max-md:max-w-full">
          {lessonData.topics.map((topic, index) => (
            <div key={index} className="flex gap-2 items-center px-2 py-3 w-full bg-white bg-opacity-10">
        ...
        <div className="flex items-start py-2 w-full text-lg font-semibold bg-slate-300 text-neutral-900 max-md:max-w-full">
          <div className="flex flex-1 shrink gap-2 items-center p-2 basis-0 min-w-[240px]">
