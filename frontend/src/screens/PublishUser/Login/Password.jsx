    ...
    <div className="flex z-0 flex-col w-full max-lg:max-w-full">
      <div className="flex flex-col w-full leading-none text-white max-lg:max-w-full">
        <div className="flex flex-col self-center max-w-full">
          <h2 className="flex gap-3 items-end self-center px-3 max-w-full lg:text-2xl max-lg:text-[16px] font-semibold text-center text-white font-['Montserrat'] leading-loose">
            Nhập mật khẩu mới
          </h2>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col w-full text-lg max-lg:text-[14px] text-white">
          ...
          <div className="flex flex-col lg:mt-4 max-lg:mt-[12px] w-full">
        ...
        <button
          type="submit"
          className="flex flex-wrap gap-5 justify-center items-center lg:mt-4 max-lg:mt-[10px] w-full text-xl max-lg:text-[16px] font-medium bg-[#CFF500] min-h-[30px] text-neutral-900 max-lg:max-w-full"
        >
          Xác nhận
        </button>
      </form>
