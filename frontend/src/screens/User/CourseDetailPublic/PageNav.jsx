...
export default function PageNav(course) {
  return (
    <nav className="flex relative flex-wrap items-center px-5 my-1.5 py-1.5 w-full text-[18px] font-semibold leading-none text-white bg-white/15 backdrop-blur-[60px] max-md:max-w-full">
