...
const CourseSection = forwardRef(({ title, description, children }, ref) => {
  return (
    ...
    >
      <div className="flex flex-col w-full text-[1.875rem] max-lg:text-[24px] font-semibold max-lg:max-w-full">
      ...
      {description && (
        <div className="font-medium text-[1.25rem] max-lg:text-[18px] max-lg:max-w-full">
          {description}
        </div>
      )}
      {children}
