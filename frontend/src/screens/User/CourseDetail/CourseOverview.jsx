...
export default function CourseOverview() {
  return (
    ...
    <div className="flex gap-3 justify-center items-center px-3 max-w-full text-xl font-medium leading-none bg-[#CFF500] border-2 border-black border-solid min-h-[40px] shadow-[-6px_6px_0px_rgba(255,255,255,1)] text-neutral-900  max-md:ml-2">
      <span className="gap-2.5 self-center my-auto">Dài hạn</span>
    </div>
    <div className="flex flex-col mt-4 md:w-[65%] max-w-full ">
        ...
        <p>
          Khóa học dành cho các bạn học viên có định hướng theo phát triển
          website phía Backend sử dụng NodeJS và các Framework liên quan.
        </p>
        <p>
          Yêu cầu chung: Khóa học sẽ dạy từ cơ bản đến nâng cao. Các bạn
          chỉ cần: chăm chỉ, không ngại hỏi đáp cũng như đưa ra các thắc
          mắc trong quá trình học tập.
          </p>
          <p>
          Sau khóa học, các bạn có thể tự tin ứng tuyển vị trí Fresher tại
          các công ty.
        </p>
        </div>
        </div>
