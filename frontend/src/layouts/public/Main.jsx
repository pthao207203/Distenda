...
const Main = () => {
  ...
  return (
    <div className="bg-[url('../Image/BG.png')] overflow-x-hidden bg-cover bg-center bg-fixed flex flex-col justify-center pb-0 bg-[#131313] min-h-screen">
      {token ? (
        <HeaderPrivate setHeaderHeight={setHeaderHeight} headerRef={headerRef} handleTaskBarToggle={handleTaskBarToggle} />
      ) : (
      ...
      >
        {isTaskBarVisible && (
          <div className="fixed inset-0 z-50 flex items-start justify-end right-[18px]" style={{ marginTop: `${headerHeight}px` }}>
            <TaskBar />
          </div>
        )}
