      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="flex flex-1 text-white justify-end gap-8 items-center text-xl font-semibold text-center max-md:text-lg max-md:max-w-full">
          <Nav.Item>
            <Nav.Link
              href="#about"
              className={`flex text-white gap-3 justify-center items-center self-stretch px-3 py-3.5 my-auto ${activeLink === 'about' ? 'text-black bg-[#CFF500]' : ''
                }`}
          ...
          <Nav.Item>
            <Nav.Link
              href="#login"
              className={`flex gap-3 justify-center items-center self-stretch px-3 py-3.5 my-auto ${activeLink === 'login' ? 'text-black bg-[#CFF500]' : ''
                }`}
          ...
          <Nav.Item>
            <Nav.Link
              href="#signup"
              className={`flex gap-3 justify-center items-center self-stretch px-3 py-3.5 my-auto ${activeLink === 'signup' ? 'text-black bg-[#CFF500]' : ''
                }`}
          ...
          <Nav.Item>
            <Nav.Link
              href="#help"
              className={`flex gap-3 justify-center items-center self-stretch px-3 py-3.5 my-auto ${activeLink === 'help' ? 'text-black bg-[#CFF500]' : ''
                }`}
