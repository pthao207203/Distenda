  ...
  return (
    <footer className="flex flex-col  px-40 py-10 w-full bg-[#131313] max-md:px-5 max-md:pt-5 max-md:max-w-full">
      <div className="self-center justify-between w-full max-md:max-w-full">
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-wrap justify-around mt-10 text-lg leading-loose text-center text-white max-md:mt-0 max-md:justify-start max-md:self-start">
              <nav className="flex self-center overflow-hidden flex-col py-auto my-auto">
                <h3 className=" font-semibold tracking-tight leading-tight text-white uppercase text-[1.5rem]">
                  VỀ CHÚNG TÔI
                </h3>
                <a
                  href="#about"
                  className="overflow-hidden px-16 py-1 mt-4 w-full max-md:px-5"
                >
                  Giới thiệu
                </a>
                <a
              ...
              <nav className="flex self-center overflow-hidden flex-col py-auto my-auto ">
                ...
                <a
                  href="#privacy"
                  className="overflow-hidden px-7 py-1 mt-4 w-full max-md:px-5"
                >
                  Chính sách bảo mật
                </a>
                <a
        ...
        <div className="flex flex-wrap gap-5 self-stretch justify-between mt-2 w-full text-sm leading-none text-[#cff500] text-[0.875rem] max-w-[1476px] max-md:max-w-full">
